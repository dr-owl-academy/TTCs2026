...
//start with middle pose since we know where to start it
    ...
    private final Pose ball3Pose = new Pose(27.4282145960422,21.987112844302306,Math.toRadians(0));
