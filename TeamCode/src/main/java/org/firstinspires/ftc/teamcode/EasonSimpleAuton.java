...
public class EasonSimpleAuton extends OpMode {
    ...
    private static final Pose DRIVE_START_POSE_2 = new Pose(24,72,Math.toRadians(-63));
    private static final Pose TARGET_POSE_2 = new Pose(48,24,Math.toRadians(-63));
    ...
    private void buildPath(){
        ...
        driveToTarget_2=follower.pathBuilder()
                ...
                //Maintain Heading
                .setConstantHeadingInterpolation(Math.toRadians(-63))
                .build();
    }
    ...
    private void autonomousPathUpdate() {
        switch (autoState) {
            ...
            case START_TURN_2:
                //Turn to 180 degrees in PedroPathing
                follower.turnTo( Math.toRadians(-63));
